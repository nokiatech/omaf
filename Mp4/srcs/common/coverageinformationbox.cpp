...
void CoverageInformationBox::writeBox(ISOBMFF::BitStream& bitstr)
{
    ...
    for (auto& region : mSphereRegions)
    {
        ...
        bitstr.write8Bits(region->region.interpolate ? 0b10000000 : 0x0);
    }
...
void CoverageInformationBox::parseBox(ISOBMFF::BitStream& bitstr)
{
    ...
    for (int i = 0; i < numRegions; ++i)
    {
        ...
        region->region.interpolate = (bitstr.read8Bits() >> 7) == 0x01;
