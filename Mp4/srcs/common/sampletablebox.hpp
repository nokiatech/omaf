...
public:
     ...
     */
    void setSampleGroupDescriptionBox(UniquePtr<SampleGroupDescriptionBox> sgpd);
...
private:
    ...
    UniquePtr<SampleGroupDescriptionBox> mSampleGroupDescriptionBox;  ///< Pointer to the sample group description box
    Vector<SampleToGroupBox> mSampleToGroupBox;                       ///< Vectory of sample-to-group boxes
