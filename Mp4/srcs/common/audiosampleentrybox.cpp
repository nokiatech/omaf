...
void AudioSampleEntryBox::writeBox(BitStream& bitstr)
{
...
const Box* AudioSampleEntryBox::getConfigurationBox() const
{
    logError() << "AudioSampleEntryBox::getConfigurationBox() not impelmented " << std::endl;
    return nullptr;
}

const DecoderConfigurationRecord* AudioSampleEntryBox::getConfigurationRecord() const
{
    logError() << "AudioSampleEntryBox::getConfigurationRecord() not impelmented" << std::endl;
    return nullptr;
}
