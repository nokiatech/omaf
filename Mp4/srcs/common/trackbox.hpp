...
public:
    ...
    /** @brief Gets the reference of the SphericalVideoV1Box.
     *  @return Reference to the  Track Group Box. **/
    SphericalVideoV1Box& getSphericalVideoV1Box();
    const SphericalVideoV1Box& getSphericalVideoV1Box() const;

    /** @brief Sets information about whether the track has SphericalVideoV1Box.
     *  @param [in] value TRUE if track has SphericalVideoV1Box, FALSE otherwise **/
    void setHasSphericalVideoV1Box(bool value);

    /** @brief Gets information about whether the track has SphericalVideoV1Box.
     *  @return TRUE if track has SphericalVideoV1Box, FALSE otherwise **/
    bool getHasSphericalVideoV1Box() const;
...
private:
    ...
    // Google Spherical Video V1
    bool mHasGoogleSphericalVideoV1Box;
    SphericalVideoV1Box mSphericalVideoV1Box;
};
