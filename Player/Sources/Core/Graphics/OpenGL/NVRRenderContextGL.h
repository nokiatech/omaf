...
: public IRenderContext
{
    public:
        ...
        RenderContextGL(RendererType::Enum type, RenderBackend::Parameters& parameters);
    ...
    private:
        ...
        void_t enableVertexAttributes();
        void_t disableVertexAttributes();
    
    private:
    
        RenderBackend::Capabilities mCapabilities;

        FixedArray<VertexBufferGL, OMAF_MAX_VERTEX_BUFFERS> mVertexBuffers;
        FixedArray<IndexBufferGL, OMAF_MAX_INDEX_BUFFERS> mIndexBuffers;
        FixedArray<ShaderGL, OMAF_MAX_SHADERS> mShaders;
        FixedArray<ShaderConstantGL, OMAF_MAX_SHADER_CONSTANTS> mShaderConstants;
        FixedArray<TextureGL, OMAF_MAX_TEXTURES> mTextures;
        FixedArray<RenderTargetGL, OMAF_MAX_RENDER_TARGETS> mRenderTargets;
    
        GLuint mVAOHandle;
        GLuint mHostVAOHandle;
};
