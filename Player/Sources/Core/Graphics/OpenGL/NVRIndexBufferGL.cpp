...
bool_t IndexBufferGL::create(BufferAccess::Enum access,
                             ...
                             size_t bytes)
{
    ...
    if (mHandle != 0)
    {
        ...
        OMAF_GL_CHECK(glBufferData(GL_ELEMENT_ARRAY_BUFFER, (GLsizeiptr)mBytes, (const GLvoid*)data, getBufferUsageGL(access)));
