...
OMAF_NS_BEGIN
    ...
    void_t VertexBufferD3D11::bufferData(ID3D11DeviceContext* deviceContext, size_t offset, const void_t* data, size_t bytes)
    {
    ...
    void_t VertexBufferD3D11::bindCompute(ID3D11DeviceContext* deviceContext, uint16_t stage, ComputeBufferAccess::Enum computeAccess)
    {
