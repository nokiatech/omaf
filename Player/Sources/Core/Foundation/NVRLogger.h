...
#define OMAF_LOG_TRACE() \
    OMAF_NS::LogDispatcher::logVerbose(OMAF_LOG_ZONE_TAG, "%s (%s:%d)", OMAF_FUNCTION, OMAF_FILE, OMAF_LINE)
...
#if OMAF_ABR_LOGGING
#define OMAF_LOG_ABR(...) OMAF_NS::LogDispatcher::logInfo(OMAF_LOG_ZONE_TAG, ##__VA_ARGS__)
#else
#define OMAF_LOG_ABR(...)
#endif
