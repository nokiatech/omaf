...
OMAF_NS_BEGIN
/*
 * A very basic class for constructing JSON object. E.g. no editing possible, only adding, and only a limited set of
...
public:
    ...
    // Note! getData adds } to the end, so it cannot be called twice. Use peekData if you want to e.g. print the data to
    // a log before actual get
