...
OMAF_NS_BEGIN
    namespace LogDispatcher
    {
        ...
        static uint8_t mLogMask = LogLevel::Verbose | LogLevel::Debug | LogLevel::Info | LogLevel::Warning | LogLevel::Error;
        ...
        {
            if (!(mLogMask&LogLevel::Verbose)) return;
        ...
        {
            if (!(mLogMask&LogLevel::Debug)) return;
        ...
        {
            if (!(mLogMask&LogLevel::Info)) return;
        ...
        {
            if (!(mLogMask&LogLevel::Warning)) return;
        ...
        {
            if (!(mLogMask&LogLevel::Error)) return;
