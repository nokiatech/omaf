...
namespace VASLongitudeDirection
{
    enum Enum
    {
        ...
        COUNTER_CLOCKWISE,  // OMAF, longitude increases from right to left. This is the internal direction in viewport
                            // classes
        COUNT
    };
}
...
public:
    ...
    virtual void_t set(float64_t longitude,
                       float64_t latitude,
                       float64_t horFov,
                       float64_t verFov,
    ...
    virtual float64_t
    getCenterLongitude(VASLongitudeDirection::Enum aDirection = VASLongitudeDirection::COUNTER_CLOCKWISE) const;
...
public:
    ...
    void_t setPosition(float64_t longitude,
                       float64_t latitude,
                       float64_t width,
                       float64_t height,
