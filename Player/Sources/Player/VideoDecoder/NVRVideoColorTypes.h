...
struct VideoMatrixCoefficients
{
    enum Enum
    {
        ...
        // 4, United States Federal Communications Commission Title 47 Code of Federal Regulations (2003) 73.682 (a) (20)
...
struct VideoTransferCharacteristics
{
    enum Enum
    {
        ...
        ITU_R_BT_2020_10 = 14, // Rec. ITU-R BT.2020-2 (10 bit system) (functionally the same as the values 1, 6, and 15; the value 1 is preferred)
        
        ITU_R_BT_2020_12 = 15, // Rec. ITU-R BT.2020-2 (12 bit system) (functionally the same as the values 1, 6, and 15; the value 1 is preferred)
        
        SMPTE_ST_2048 = 16, // Society of Motion Picture and Television Engineers ST 2084 for 10, 12, 14, and 16-bit systems
