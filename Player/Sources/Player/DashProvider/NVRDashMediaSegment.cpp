...
DashSegment::DashSegment(size_t bufferSize,
                         uint32_t segmentId,
                         uint32_t initSegmentId,
                         bool_t aIsInitSegment,
                         DashSegmentObserver* observer)
    : mData(OMAF_NEW(*MemorySystem::DefaultHeapAllocator(), DataBuffer<uint8_t>)(*MemorySystem::DefaultHeapAllocator(),
                                                                                 bufferSize))
...
DashSegment::DashSegment(int64_t rangeStart,
                         size_t bufferSize,
                         uint32_t segmentId,
                         uint32_t initSegmentId,
                         bool_t aIsInitSegment,
...
void_t DashSegment::setTimestampBase(uint32_t aTimestampBase)
{
    mTimestampBase = aTimestampBase;
}

uint32_t DashSegment::getTimestampBase() const
{
