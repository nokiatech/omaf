...
OMAF_NS_BEGIN
class CubeMapRenderer : public VideoRenderer
{
public:
    CubeMapRenderer();
    ~CubeMapRenderer();
...
private:  // Implements PanoramaRenderer
    ...
    void_t updateCubeMapData(CubeMapSource* source);
    void_t createCubemapVideoShader(VideoShader& shader,
